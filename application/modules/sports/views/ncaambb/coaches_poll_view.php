...
* Subject : NCAAMBB USA Today Coaches Poll
...
$json_file = file_get_contents('http://api.sportradar.us/ncaamb-t3/polls/US/2015/rankings.json?api_key=gg3yj88mhd5ea7g5theszkf8');
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo site_url('sports/ncaambb_coaches_poll'); ?>"><i class="fa fa-circle-o"></i>Coaches poll</a></li>
          </ul>
        </li>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        NCAAMBB - USA Today Coaches Poll
        <small></small>
      </h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">USA Today Coaches Poll</li>
        ...
        <section class="content">
          <div class="row">
           ...
           <div class="box-header with-border">
                  <h3 class="box-title">USA Today Coaches Poll</h3>
                </div>
            <!-- /.box-header -->
                <div class="box-body">
