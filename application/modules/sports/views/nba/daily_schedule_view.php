...
$json_file = file_get_contents('https://api.sportradar.us/nba-t3/games/2016/10/26/schedule.json?api_key=s2n89799m8hfjkapcvb7qsxk');
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo site_url('sports/nba_daily_schedule'); ?>"><i class="fa fa-circle-o"></i>Daily Schedule</a></li>
        ...
        <section class="content">
          <div class="row">
            ...
            foreach ($zero_g as $post) {
                ...
                if ($post->home->alias == 'SAS') {
                    
                    $post->home->alias = 'SA';

                }elseif ($post->away->alias == 'SAS') {
                    
                    $post->away->alias = 'SA';

                }

                if ($post->home->alias == 'GSW') {
                    
                    $post->home->alias = 'GS';

                }elseif ($post->away->alias == 'GSW') {
                    
                    $post->away->alias = 'GS';
                }

                if ($post->home->alias == 'NYK') {
                    
                    $post->home->alias = 'NY';

                }elseif ($post->away->alias == 'NYK') {
                    
                    $post->away->alias = 'NY';
                }

                if ($post->home->alias == 'NOP') {
                    
                    $post->home->alias = 'NO';

                }elseif ($post->away->alias == 'NOP') {
                    
                    $post->away->alias = 'NO';
                }

                if ($post->home->alias == 'LAL') {
                    
                    $post->home->alias = 'LAK';

                }elseif ($post->away->alias == 'LAL') {
                    
                    $post->away->alias = 'LAK';
                }

                if ($post->home->alias == 'MIL') {
                    
                    $post->home->alias = 'MLW';

                }elseif ($post->away->alias == 'MIL') {
                    
                    $post->away->alias = 'MLW';
                }

                if ($post->home->alias == 'PHX') {
                    
                    $post->home->alias = 'PHO';

                }elseif ($post->away->alias == 'PHX') {
            ...
            ?>
                ...
                <tbody>
                    <tr>
                    <td><?php echo "<img src = http://www.rotoworld.com/img/NBA/teams/logos/".$post->away->alias.".png alt='".$post->away->alias."' style='width:90px;height:75px;'> ";?><?php echo $post->away->name; ?></td>
                        <td><?php echo "<img src = http://www.rotoworld.com/img/NBA/teams/logos/".$post->home->alias.".png alt='".$post->home->alias."' style='width:90px;height:75px;'> ";?><?php echo $post->home->name; ?></td>
