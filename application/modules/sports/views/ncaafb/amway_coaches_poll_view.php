...
// copy file content into a string var
 $json_file = file_get_contents('http://api.sportradar.us/ncaafb-t1/polls/EU25/2016/11/rankings.json?api_key=vdmmregqeetyd9cry962fvq9');
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo site_url('sports/ncaafb_amway_coaches_poll'); ?>"><i class="fa fa-circle-o"></i>Amway Coaches Poll</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Amway Coaches Poll</li>
          ...
          <div class="row">
           ...
           <div class="box-header with-border">
                  <h3 class="box-title">Amway Coaches Poll</h3>
                </div>
            <!-- /.box-header -->
                <div class="box-body">
