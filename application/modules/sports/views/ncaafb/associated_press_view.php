...
$json_file = file_get_contents('http://api.sportradar.us/ncaafb-t1/polls/AP25/2016/11/rankings.json?api_key=vdmmregqeetyd9cry962fvq9');
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo site_url('sports/ncaafb_associated_press'); ?>"><i class="fa fa-circle-o"></i>Associated Press Top 25</a></li>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        NCAAFB - Associated Press Top 25
        <small></small>
      </h1>
